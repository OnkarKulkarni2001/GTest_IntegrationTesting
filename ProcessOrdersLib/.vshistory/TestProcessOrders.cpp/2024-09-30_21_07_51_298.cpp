...
TEST_F(cProcessOrderTest, AddToCart_ValidProduct) {
    cProducts* product = new cProducts(1, "Test Product 1", "Test Product 1 Description", 49, 39.99);
...
TEST_F(cProcessOrderTest, CalculateOrderTotal_WithItems) {
    cProducts* product = new cProducts(2, "Test Product 2", "Test Product 2 Description", 59, 49.99);
    order->AddToCart(product);
