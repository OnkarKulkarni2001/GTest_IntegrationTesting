...
TEST_F(cProcessOrder, AddToCart_GoodProduct) {
	cProcessOrder order;
...
TEST_F(cProcessOrder, AddToCart_BadProduct) {
	cProcessOrder order;
...
TEST_F(cProcessOrder, CalculateOrderTotal_GoodProduct) {
	cProcessOrder order;
	cProducts* goodProduct = new cProducts(101, "Good Product", "Good Description", 69, 69.69, 1.0, true);
...
TEST_F(cProcessOrder, CalculateOrderTotal_DiscountedProduct) {
	cProcessOrder order;
...
TEST_F(cProcessOrder, CalculateOrderTotal_BadProduct) {
	cProcessOrder order;
	cProducts* badProduct = new cProducts(420, "Bad Product", "Bad Description", 24, 27.99, 1.0, false);
